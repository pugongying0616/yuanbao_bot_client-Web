...
使用一键安装命令：curl -sSL https://yuanbao-bot-client-web.pages.dev/install-cpp.sh | bash下载，或者下载并解压项目安装包到设备存储目录，或者依次下载各项目文件到设备存储目录
...
- ✅删除插件功能残留
- ✅修复消息列表序号与后端index不一致问题

### v5.3（2026-08-09）

- ✅修复发送页子功能选择框凸显异常问题
- ✅成员快捷使用键功能改为自动跳转发送者@艾特
...
- ✅ 新增主题(QQ桌面端调色盘🎨)，支持设置多种颜色主题
- ✅撤回消息监听功能的消息界面显示支持设置“红橙黄绿青蓝紫”七种颜色
- ✅删除插件功能
- ✅修复贴纸显示功能
- ✅“撤回监听”设置从“记录”挪到“设置”
